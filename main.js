...
var nextLevel = 'no';
var level = 0;
var nextlevelbuttonhtml=document.getElementById('nextlevelbutton');
// var newflag=level*5;
...
level += 5;
    playGameLevel();
    nextlevelbuttonhtml.hidden=true;
}
...
function playGameLevel() {
    ...
    function NextLevel() {
        ...
        nextlevelbuttonhtml.hidden = false;
       y=[0,0,0,0,0]
       x = shuffleArray(unshuffledX)
}
    }
